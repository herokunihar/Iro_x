...
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6685219583").split())
)
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/herokunihar/Iro_x")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")

GIT_TOKEN = getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/DP_ZONEIng")
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/OYE_LOVEYOU")
